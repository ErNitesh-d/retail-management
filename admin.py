...
def about():
    ...
    root.title("ABOUT US")
    root.config(bg="pink")  
    label_text_1 = "Welcome to our Retail Management System!"
    label_text_2 = "At our company, we are committed to providing the best possible retail management solutions to our clients. "
    label_text_3 = "We understand the unique challenges that retailers face in today's fast-paced and ever-changing business landscape, "
    label_text_4 = "and we work hard to deliver innovative and effective solutions that help our clients succeed."
    label_text_5 = "Our team of experienced professionals is dedicated to providing exceptional customer service and support, "
    label_text_6 = "and we pride ourselves on building long-term relationships with our clients based on trust and mutual success."
    label_text_7 = "Thank you for choosing our Retail Management System."
    label_text_8= "We look forward to working with you!"
    
    font = ("Arial", 18)
    font2=("Algerian",28)
    font3=("Lucida Handwriting",22)
    fg = "black"
    bg="pink"
    label1 = Label(root, text=label_text_1, font=font, fg=fg,bg=bg)
    label2 = Label(root, text=label_text_2, font=font, fg=fg,bg=bg)
    label3 = Label(root, text=label_text_3, font=font, fg=fg,bg=bg)
    label4 = Label(root, text=label_text_4, font=font, fg=fg,bg=bg)
    label5 = Label(root, text=label_text_5, font=font, fg=fg,bg=bg)
    label6 = Label(root, text=label_text_6, font=font, fg=fg,bg=bg)
    label7 = Label(root, text=label_text_7, font=font2, fg=fg,bg=bg)
    label8 = Label(root, text=label_text_8, font=font2, fg=fg,bg=bg)
    signature = Label(root, text="Developer Name", font=font2, fg=fg, bg=bg)
    signature2 = Label(root, text="Dagiya Nitesh.....", font=font3, fg=fg, bg=bg)
    ...
    signature.grid(column=0, row=16, sticky="SE")
    signature2.grid(column=0, row=17, sticky="SE")
    root.mainloop()
